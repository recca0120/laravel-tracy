<style>
	#tracy-debug .Laravel-HtmlValidatorPanel {
        min-width: 700px;
    }
	#tracy-debug .Laravel-HtmlValidatorPanel table {
		width: 100%;
		max-width: 700px;
	}
	#tracy-debug .Laravel-HtmlValidatorPanel table pre {
		max-width: 670px;
		overflow: hidden;
		box-shadow: none !important;
	}
    #tracy-debug .Laravel-HtmlValidatorPanel td span.severenity-1 {
        color: #aaaa30 !important;
        font-weight: bold !important;
    }
    #tracy-debug .Laravel-HtmlValidatorPanel td span.severenity-2 {
        color: #aa832f !important;
	    font-weight: bold !important;
    }
    #tracy-debug .Laravel-HtmlValidatorPanel td span.severenity-3 {
        color: #aa4c34 !important;
	    font-weight: bold !important;
    }
    #tracy-debug .Laravel-HtmlValidatorPanel span.highlight {
	    background: #CD1818;
	    color: white;
	    font-weight: bold;
	    font-style: normal;
